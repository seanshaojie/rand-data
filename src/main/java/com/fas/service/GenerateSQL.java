...
import com.fas.entity.ParaBean;
import com.fas.util.Faker;
import com.fas.util.JsonUtil;
...
*/
					...
					if(funcname.equalsIgnoreCase("Bank.allcard")) {value=value+"'"+faker.bank().allcard()+"',";}
